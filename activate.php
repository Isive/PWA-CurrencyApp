...
form .signup-link a:hover{
  ...
  <body>
    ...
    <div class="container">
      <div class="wrapper">
        <div class="title"><span>Aktywacja</span></div>
        <form action="activate.php" method="POST">

        <div class="row">
            <i class="fas fa-user"></i>
            <input type="text" name="email-aktywacja" placeholder="Email" required>
          </div>

          <div class="row">
            <i class="fas fa-user"></i>
            <input type="text" name="token" placeholder="Kod aktywacyjny" required>
          </div>
